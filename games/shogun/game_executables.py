"""SHOGUN — Core game mechanics: Expanding Wilds with Multipliers."""
...
class GameExecutables(GameCalculations):
    ...
    def expand_wild_reel(self, reel_index: int) -> None:
        ...
        All positions in the reel become W symbols.
        """
    ...
    def assign_wild_reel_multiplier(self, reel_index: int) -> int:
        ...
        The multiplier is applied to all W symbols on that reel.
        """
    ...
    def apply_expanding_wilds(self) -> list:
        ...
        Returns list of dicts: [{"reel": int, "mult": int}, ...]
        """
    ...
    def check_scatter_trigger(self) -> tuple:
        ...
        Returns (triggered: bool, scatter_positions: list).
        """
    ...
    def trigger_freespins_from_scatter(self, scatter_positions: list) -> None:
        """
        Trigger free spins from scatter symbols.
        3 scatters → 10 free spins (both base and free game retrigger).
        """
        self.record({
            "kind": "scatter",
            "symbol": "SC",
    ...
    # ── Sticky Wild Management (Free Spins) ──────────────────────────────────

    def restore_sticky_wilds(self) -> None:
        """
        Restore all sticky wild reels from previous free spins onto the board.
        Their multipliers are preserved.
        """
    ...
    def add_sticky_wild_reels(self, expanded_wilds: list) -> None:
        ...
        Only adds reels not already in sticky_wild_reels.
        """
    ...
    def pre_place_expanding_wild(self) -> None:
        ...
        Expands the reel, assigns multiplier, and adds to sticky list.
        """
